...
export const metadata: ToolMeta = {
  ...
  short_description: "Nobody wants to worry about money when they're old, but getting to that point requires a lot of planning. In my retirement planning journey I found a bunch of RRIF calculators but none that gave me a full picture of how much money I'd need in order to retire.",
